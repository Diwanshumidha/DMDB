  ...
  return (
    <div className=" h-[70vh] max-md:h-[50vh] max-sm:h-[40vh] bg-[#072755] shadow-xl relative">
      ...
      <div className="relative h-full">
        ...
        <div className=" bottom-10 absolute left-5 sm:left-8 md:left-10   text-white  ">
        ...
        <div className=" bottom-10 absolute left-3 sm:left-8 md:left-10  w-max h-max  text-white  ">
